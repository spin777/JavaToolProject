...
//            setNumberValue(freeType, cvo.getFreeType());
    ...
    void runGame() {
        ...
        if(freeType.getText().equals("") || freeType.getText() == null) {
            gameVo.setFreeType(-1);
        }else {
            gameVo.setFreeType(Integer.parseInt(freeType.getText()));
        }
    ...
    void send() {
        Thread.startVirtualThread(() -> {
            ...
            for (int i = 1; i <= runNum; i++) {
                ...
                builder.setKind(gameVo.getFreeType());
